...
class PiotroskiScore(BaseFilter):
    ...
    def __calculate_roa(self):
        ...
        net_income_prev = self.stock.get_data_attr(
            "income", "netIncome", quarter_diff=4
        )
        total_assets_prev = self.stock.get_data_attr(
            "balance", "totalAssets", quarter_diff=4
        )
    ...
    def __calculate_debtassetratio(self):
        ...
        total_assets = self.stock.get_data_attr("balance", "totalAssets")
        ltd_prev = self.stock.get_data_attr("balance", "longTermDebt", quarter_diff=4)
        total_assets_prev = self.stock.get_data_attr(
            "balance", "totalAssets", quarter_diff=4
        )
        return (ltd / total_assets, ltd_prev / total_assets_prev)
    ...
    def __calculate_current_ratio(self):
        ...
        assets_prev = self.stock.get_data_attr(
            "balance", "totalCurrentAssets", quarter_diff=4
        )
        lia_prev = self.stock.get_data_attr(
            "balance", "totalCurrentLiabili", quarter_diff=4
        )
    ...
    def __calculate_gross_margin(self):
        ...
        total_revenue_prev = self.stock.get_data_attr(
            "income", "totalRevenue", quarter_diff=4
        )
    ...
    def __calculate_total_shares(self):
        ...
        shares_prev = self.stock.get_data_attr(
            "balance", "totalSharesOutst", quarter_diff=4
        )
    ...
    def analyse(self):
        self.calc = (
            self.__calculate_profitability()
